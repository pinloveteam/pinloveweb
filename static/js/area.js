...
dsy.add("0_1_0",["伯明翰 Birmingham","蒙哥马利 Montgomery","莫比尔 Mobile","亨茨维尔  Huntsville"]);
dsy.add("0_1_1",["安克雷奇 Anchorage","朱诺 Juneau","费尔班克斯 Fairbanks"]);
dsy.add("0_1_2",["吉尔伯特 Gilbert","图森 Tucson","坦佩 Tempe","斯科茨代尔 Scottsdale","格伦代尔 Glendale","梅萨 Mesa","皮奥里亚 Peoria","钱德勒 Chandler","凤凰城 Phoenix"]);
dsy.add("0_1_3",["小石城 Little Rock","史密斯堡 Fort Smith","费耶特维尔 Fayetteville"]);
dsy.add("0_1_4",["丘拉维斯塔 Chula Vista","亨丁顿滩 Huntington Beach","伯班克 Burbank","千橡市 Thousand Oaks","唐尼 Downey","园林市 Garden Grove","圣塔克拉拉 Santa Clara","埃尔蒙特 El Monte","埃斯孔迪多 Escondido","埃尔克格罗夫 Elk Grove","奧克斯纳德 Oxnard","奧克兰 Oakland","安大略 Ontario","安提克 Antioch","安那罕 Anaheim","富勒顿 Fullerton","帕萨迪纳 Pasadena","库卡蒙格牧场 Rancho Cucamonga","康科德 Concord","弗里蒙特 Fremont","弗雷斯诺 Fresno","戴利城 Daly City","托伦斯 Torrance","圣伯纳文图拉 San Buenaventura","斯托克顿 Stockton","方塔纳 Fontana","柏克莱 Berkeley","格伦代尔 Glendale","棕榈谷 Palmdale","森尼韦尔 Sunnyvale","橙市 Orange","欧申塞德 Oceanside","波莫纳 Pomona","洛杉矶 Los Angeles","海沃德 Hayward","尔湾 Irvine","瓦列霍 Vallejo","科斯塔梅萨 Costa Mesa","科洛那 Corona","维塞利亚 Visalia","罗斯维尔 Roseville","圣地亚哥 San Diego","圣塔克拉利塔 Santa Clarita","圣安娜 Santa Ana","圣罗莎 Santa Rosa","圣荷西 San Jose","圣贝纳迪诺 San Bernardino","旧金山 San Francisco","英格尔伍德 Inglewood","莫德斯托 Modesto","莫雷诺谷 Moreno Valley","萨克拉门托 Sacramento","萨利纳斯 Salinas","兰开斯特 Lancaster","西柯汶纳 West Covina","西米谷 Simi Valley","诺沃克 Norwalk","贝克斯菲尔德 Bakersfield","费尔菲尔德 Fairfield","里奇蒙 Richmond","里弗塞德 Riverside","长滩 Long Beach"]);
dsy.add("0_1_5",["丹佛 Denver","奧罗拉 Aurora","普韦布洛 Pueblo","桑顿 Thornton","科林斯堡 Fort Collins","科罗拉多泉 Colorado Springs","莱克伍德 Lakewood","西敏 Westminster","阿瓦达 Arvada"]);
dsy.add("0_1_6",["桥港 Bridgeport","哈特福 Hartford","纽黑文 New Haven","斯坦福 Stamford","沃特伯里 Waterbury"]);
dsy.add("0_1_7",[ "威尔明顿 Wilmington","多佛 Dover","纽瓦克 Newark"]);
dsy.add("0_1_8",["华盛顿 Washington"]);
dsy.add("0_1_9",["杰克逊维尔 Jacksonville","迈阿密 Miami","坦帕 Tampa","圣彼德斯堡 St. Petersburg","奥兰多 Orlando","海厄利亚 Hialeah","劳德代尔堡 Fort Lauderdale","塔拉哈西 Tallahassee","开普科勒尔 Cape Coral","潘布鲁克派恩斯 Pembroke Pines","好莱坞 Hollywood","圣露西港 Port St. Lucie","科勒尔斯普林斯 Coral Springs","盖恩斯韦尔 Gainesville","米拉馬尔 Miramar","克利尔沃特 Clearwater","庞帕诺比奇 Pompano Beach"]);
dsy.add("0_1_10",[ "亚特兰大 Atlanta","奥古斯塔 Augusta","哥伦布 Columbus","沙瓦纳 Savannah","雅典 Athens"]);
dsy.add("0_1_11",["檀香山 Honolulu","希洛 Hilo","凯卢阿 Kailua"]);
dsy.add("0_1_12",["博伊西 Boise","楠帕 Nampa","爱达荷福尔斯 Idaho Falls"]);
dsy.add("0_1_13",["芝加哥 Chicago","奥罗拉 Aurora","罗克福德 Rockford","內珀韦尔 Naperville","乔利埃特 Joliet","斯普林菲尔德 Springfield","皮奧里亚 Peoria","埃尔金 Elgin"]);
dsy.add("0_1_14",["印第安纳波利斯 Indianapolis","韦恩堡 Fort Wayne","埃文斯维尔 Evansville","南本德 South Bend"]);
dsy.add("0_1_15",["德梅因 Des Moines","锡达拉皮兹 Cedar Rapids","达文波特 Davenport"]);
dsy.add("0_1_16",["威奇托 Wichita","欧弗兰帕克 Overland Park","堪萨斯城 Kansas City","托皮卡 Topeka","奧拉西 Olathe"]);
dsy.add("0_1_17",["路易维尔 Louisville","列克星敦 Lexington","欧文斯伯勒 Owensboro","法兰克福 Frankfort"]);
dsy.add("0_1_18",["新奥尔良 New Orleans","巴吞鲁日 Baton Rouge","什里夫波特 Shreveport","拉法叶 Lafayette"]);
dsy.add("0_1_19",["波特兰 Portland","刘易斯顿 Lewiston","班戈 Bangor","奥古斯塔 Augusta"]);
dsy.add("0_1_20",["巴尔的摩 Balitmore","弗雷德里克 Frederick","盖瑟斯堡 Gaithersburg","安纳波利斯 Annapolis"]);
dsy.add("0_1_21",["波士顿 Boston","乌斯特 Worcester","斯普林菲尔德 Springfield","洛厄尔 Lowell","剑桥 Cambridge"]);
dsy.add("0_1_22",["沃伦 Warren","斯特灵海茨 Sterling Heights","兰盛 Lansing","大急流城 Great Rapids","弗林特 Flint","底特律 Detroit","安娜堡 Ann Arbor"]);
dsy.add("0_1_23",["明尼阿波利斯 Minneapolis","圣保罗 Saint Paul","罗切斯特 Rochester"]);
dsy.add("0_1_24",["杰克逊 Jackson","格尔夫波特 Gulfport","比洛克西 Biloxi"]);
dsy.add("0_1_25",["堪萨斯城 Kansas City","圣路易斯 Sanit Louis","斯普林菲尔德 Springfield","独立城 Independence","杰斐逊城 Jefferson"]);
dsy.add("0_1_26",["比灵斯 Billings","米苏拉 Missoula","大瀑布城 Great Falls","海伦娜 Helena"]);
dsy.add("0_1_27",["奥马哈 Omaha","林肯 Lincoln","贝尔维尤 Bellevue"]);
dsy.add("0_1_28",["拉斯维加斯 Las Vegas","亨德森 Henderson","里诺 Reno","北拉斯维加斯 North Las Vegas","卡森城 Carson"]);
dsy.add("0_1_29",["曼彻斯特 Manchester","纳舒厄 Nashua","康科德 Concord"]);
dsy.add("0_1_30",["纽瓦克 Newark","泽西城 Jersey City","帕特森 Paterson","伊丽莎白 Elizabeth","特伦顿 Trenton"]);
dsy.add("0_1_31",["阿布奎基 Albuquerque","拉斯克鲁塞斯 Las Cruces","圣大非 Santa Fe"]);
dsy.add("0_1_32",["纽约市 New York","水牛城 Buffalo","罗切斯特 Rochester","杨克斯 Yonkers","雪城 Syracuse","奥尔巴尼 Albany"]);
dsy.add("0_1_33",["格林斯伯勒 Greensboro","温斯顿-塞勒姆 Winston-Salem","罗利 Raleigh","费叶特韦 Fayetteville","德罕 Durham","夏洛特 Charlotte","卡瑞 Cary"]);
dsy.add("0_1_34",["法戈 Fargo","俾斯麦 Bismarck","大福克斯 Grand Forks"]);
dsy.add("0_1_35",["哥伦布 Columbus","克利夫兰 Cleveland","辛辛那堤 Cincinnati","托莱多 Toledo","代顿 Dayton","阿克伦 Akron"]);
dsy.add("0_1_36",["俄克拉荷马城 Oklahoma City","图尔萨 Tulsa","诺曼 Norman"]);
dsy.add("0_1_37",["波特兰 Portland","塞勒姆 Salem","尤金 Eugene"]);
dsy.add("0_1_38",["费城 Philadephia","匹兹堡 Pittsburgh","阿伦敦 Allentown","伊利 Erie","哈里斯堡 Harrisburg"]);
dsy.add("0_1_39",["普洛威顿斯 Providence","沃威克 Warwick","克兰斯顿 Cranston"]);
dsy.add("0_1_40",["哥伦比亚 Columbia","查尔斯顿 Charleston","北查尔斯顿 North Charleston"]);
...
dsy.add("0_1_43",["韦科 Waco","圣安东尼奥 San Antonio","普拉诺 Plano","帕萨迪纳 Pasadena","米德兰 Midland","梅斯基特 Mesquite","麦金尼 McKinney","麦卡伦 McAllen","拉伯克 Lubbock","拉雷多 Laredo","基林 Killeen","欧文 Irving","休斯顿 Houston","大草原城 Grand Prairie","加兰 Garland","福和市 Fort Worth","厄尔巴索 El Paso","登顿 Denton","达拉斯 Dallas","科珀斯克里斯蒂 Corpus Christi","卡罗尔顿 Carrollton","布朗斯韦尔 Brownsville","博蒙特 Beaumont","奧斯汀 Austin","阿灵顿 Arlington","阿马里诺 Amarillo","阿比林 Abilene"]);
...
dsy.add("0_1_46",["弗吉尼亚滩 Virginia Beach","里士满 Richmond","朴茨茅斯 Portsmouth","诺福克 Norfolk","纽波特纽斯 Newport News","汉普顿 Hampton","切萨皮克 Chesapeake","阿灵顿 Arlington","亚历山大德里亚 Alexandria"]);
dsy.add("0_1_47",["温哥华 Vancouver","西雅图 Seattle","斯波坎 Spokane","塔科马 Tacoma","贝尔维尤 Bellevue","奥林匹亚 Olympia"]);
dsy.add("0_1_48",["查尔斯顿 Charleston","亨廷顿 Huntington","帕克斯堡 Parkersburg"]);
dsy.add("0_1_49",["密尔沃基 Milwaukee","麦迪逊 Madison","绿湾 Green Bay"]);
dsy.add("0_1_50",["夏延 Cheyenne","卡斯珀 Casper","拉勒米 Laramie"]);
