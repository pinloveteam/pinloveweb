...
dsy.add("0_1",["亚拉巴马 Alabama","阿拉斯加 Alaska","亚利桑那 Arizona","阿肯色 Arkansas","加利福尼亚 California","科罗拉多 Colorado","康涅狄格 Connecticut","特拉华 Delaware","华盛顿哥伦比亚特区 District of Columbia","佛罗里达 Florida","佐治亚 Georgia","夏威夷 Hawaii","爱达荷 Idaho","伊利诺斯 Illinois","印第安纳 Indiana","艾奥瓦 Iowa","堪萨斯 Kansas","肯塔基 Kentucky","路易斯安那 Louisiana","缅因 Maine","马里兰 Maryland","马萨诸塞 Massachusetts","密歇根 Michigan","明尼苏达 Minnesota","密西西比 Mississippi","密苏里 Missouri","蒙大拿 Montana","内布拉斯加 Nebraska","内华达 Nevada","新罕布什尔 New Hampshire","新泽西 New Jersey","新墨西哥 New Mexico","纽约 New York","北卡罗来纳 North Carolina","北达科他 North Dakota","俄亥俄 Ohio","俄克拉何马 Oklahoma","俄勒冈 Oregon","宾夕法尼亚 Pennsylvania","罗得岛 Rhode Island","南卡罗来纳 South Carolina","南达科他 South Dakota","田纳西 Tennessee","得克萨斯 Texas","犹他 Utah","佛蒙特 Vermont","弗吉尼亚 Virginia","华盛顿 Washington","西弗吉尼亚 West Virginia","威斯康星 Wisconsin","怀俄明 Wyoming"]);
dsy.add("0_1_0",["伯明翰 Birmingham","蒙哥马利 Montgomery","莫比尔 Mobile"]);
dsy.add("0_1_1",["安克雷奇 Anchorage","朱诺 Juneau","费尔班克斯 Fairbanks"]);
dsy.add("0_1_2",["菲尼克斯 Phoenix","图森 Tucson","梅萨 Mesa" ]);
dsy.add("0_1_3",["小石城 Little Rock","史密斯堡 Fort Smith","费耶特维尔 Fayetteville"]);
dsy.add("0_1_4",["洛杉矶 Los Angeles 　圣迭戈 San Diego","圣何塞 San Jos","萨克拉门多 Sacramento"]);
dsy.add("0_1_5",["丹佛 Denver","科罗拉多斯普林斯 Colorado Springs","奥罗拉 Aurora"]);
dsy.add("0_1_6",["布里奇波特 Bridgeport","哈特福德 Hartford","纽黑文 New Haven"]);
dsy.add("0_1_7",[ "威尔明顿 Wilmington","多佛 Dover","纽瓦克 Newark"]);
dsy.add("0_1_8",["华盛顿 Washington"]);
dsy.add("0_1_9",["杰克逊维尔 Jacksonville","迈阿密 Miami","坦帕 Tampa"]);
dsy.add("0_1_10",[ "亚特兰大 Atlanta","奥古斯塔 Augusta","哥伦布 Columbus"]);
dsy.add("0_1_11",["檀香山 Honolulu","希洛 Hilo","凯卢阿 Kailua"]);
dsy.add("0_1_12",["博伊西 Boise","楠帕 Nampa","爱达荷福尔斯 Idaho Falls"]);
dsy.add("0_1_13",[ "芝加哥 Chicago","奥罗拉 Aurora","罗克福德 Rockford"]);
dsy.add("0_1_14",["印第安纳波利斯 Indianapolis","韦恩堡 Fort Wayne","埃文斯维尔 Evansville"]);
dsy.add("0_1_15",["得梅因 Des Moines","锡达拉皮兹 Cedar Rapids","达文波特 Davenport"]);
dsy.add("0_1_16",["威奇托 Wichita","奥弗兰帕克 Overland Park","堪萨斯城 Kansas City"]);
dsy.add("0_1_17",["路易维尔 Louisville","列克星敦 Lexington","欧文斯伯勒 Owensboro"]);
dsy.add("0_1_18",["新奥尔良 New Orleans","巴吞鲁日 Baton Rouge","什里夫波特 Shreveport"]);
dsy.add("0_1_19",["波特兰 Portland","刘易斯顿 Lewiston","班戈 Bangor"]);
dsy.add("0_1_20",["巴尔的摩 Balitmore","弗雷德里克 Frederick","盖瑟斯堡 Gaithersburg"]);
dsy.add("0_1_21",[ "波士顿 Boston","伍斯特 Worcester","斯普林菲尔德 Springfield"]);
dsy.add("0_1_22",[ "底特律 Detroit","大急流城 Grand Rapids","沃伦 Warren"]);
dsy.add("0_1_23",["明尼阿波利斯 Minneapolis","圣保罗 Saint Paul","罗切斯特 Rochester"]);
dsy.add("0_1_24",["杰克逊 Jackson","格尔夫波特 Gulfport","比洛克西 Biloxi"]);
dsy.add("0_1_25",["堪萨斯城 Kansas City","圣路易斯 Sanit Louis","斯普林菲尔德 Springfield"]);
dsy.add("0_1_26",["比灵斯 Billings","米苏拉 Missoula","大瀑布城 Great Falls"]);
dsy.add("0_1_27",["奥马哈 Omaha","林肯 Lincoln","贝尔维尤 Bellevue"]);
dsy.add("0_1_28",["拉斯维加斯 Las Vegas","亨德森 Henderson","里诺 Reno"]);
dsy.add("0_1_29",["曼彻斯特 Manchester","纳舒厄 Nashua","康科德 Concord"]);
dsy.add("0_1_30",["纽瓦克 Newark","泽西城 Jersey City","帕特森 Paterson"]);
dsy.add("0_1_31",["阿布奎基 Albuquerque","拉斯克鲁塞斯 Las Cruces","圣大非 Santa Fe"]);
dsy.add("0_1_32",["纽约市 New York","布法罗 Buffalo","罗切斯特 Rochester"]);
dsy.add("0_1_33",["夏洛特 Charlotte","罗利 Raleigh","格林斯伯勒 Greensboro"]);
dsy.add("0_1_34",["法戈 Fargo","俾斯麦 Bismarck","大福克斯 Grand Forks"]);
dsy.add("0_1_35",["哥伦布 Columbus","克利夫兰 Cleveland","辛辛那堤 Cincinnati"]);
dsy.add("0_1_36",["俄克拉荷马城 Oklahoma City","塔尔萨 Tulsa","诺曼 Norman"]);
dsy.add("0_1_37",["波特兰 Portland","塞勒姆 Salem","尤金 Eugene"]);
dsy.add("0_1_38",["费城 Philadephia","匹兹堡 Pittsburgh","阿伦敦 Allentown"]);
dsy.add("0_1_39",["普罗维登斯 Providence","沃威克 Warwick","克兰斯顿 Cranston"]);
dsy.add("0_1_40",["哥伦比亚 Columbia","查尔斯顿 Charleston","北查尔斯顿 North Charleston"]);
dsy.add("0_1_41",["苏福尔斯 Sioux Falls","拉皮德城 Rapid City","阿伯丁 Aberdeen"]);
dsy.add("0_1_42",["孟菲斯 Memphis","纳什维尔 Nashville","诺克斯维尔 Knoxville"]);
dsy.add("0_1_43",[ "休斯敦 Houston","圣安东尼奥 San Antonio","达拉斯 Dallas"]);
dsy.add("0_1_44",["盐湖城 Salt Lake City","普罗沃 Provo","西瓦利城 West Valley City"]);
dsy.add("0_1_45",["伯灵顿 Burlington","拉特兰 Rutland","南伯灵顿 South Burlington"]);
dsy.add("0_1_46",["弗吉尼亚比奇 Virginia Beach","诺福克 Norfolk","切萨皮克 Chesapeake"]);
dsy.add("0_1_47",["西雅图 Seattle","斯波坎 Spokane","塔科马 Tacoma"]);
dsy.add("0_1_48",["查尔斯顿 Charleston","亨廷顿 Huntington","帕克斯堡 Parkersburg"]);
dsy.add("0_1_49",["密尔沃基 Milwaukee","麦迪逊 Madison","格林贝 Green Bay"]);
