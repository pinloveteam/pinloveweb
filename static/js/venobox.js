          ...
          var options = $.extend(defaults, options);
            ...
            return this.each(function() {
                  ...
                  obj.click(function(e){
                    ...
                    core = '<div class="vbox-overlay"><div class="vbox-preloader">Loading...</div><div class="vbox-container"><div class="vbox-content"></div></div><div class="vbox-title"></div><div class="vbox-num">0/0</div><div class="vbox-close">X</div><div title="上一张" class="photolayer-view-prev"></div><div title="下一张" class="photolayer-view-next"></div>';
                    ...
                    function checknav(){
                      ...
                      if(thenext.length > 0 ){
                        $('.photolayer-view-next').css('display', 'block');
                        nextok = true;
                      }else{
                        $('.photolayer-view-next').css('display', 'none');
                        nextok = false;
                      }
                      if(items.index(obj) > 0 ){
                        $('.photolayer-view-prev').css('display', 'block');
                        prevok = true;
                      }else{
                        $('.photolayer-view-prev').css('display', 'none');
                        prevok = false;
                      }
                    }
                    ...
                    /* -------- NEXTGALL -------- */
                    $('.photolayer-view-next').click(function(){
                      ...
                      overlay.css('min-height', $(window).outerHeight());
                        ...
                        if (thenext.data('type') == 'iframe') {
                          ...
                          loadVimeo();
							...
							content.html('<div title="上一张" class="photolayer-view-prev"></div><div title="下一张" class="photolayer-view-next"></div><img src="'+dest+'">');
                            preloadFirst();
                        }
                        obj = thenext;
                        checknav();
                    ...
                    /* -------- PREVGALL -------- */
                    $('.photolayer-view-prev').click(function(){
                    ...
                    $('.vbox-close,.vbox-overlay').click(function(e){
                      evitacontent = '.figlio';
                      evitaprev = '.photolayer-view-prev';
                      evitanext = '.photolayer-view-next';
                      figliall = '.figlio *';
