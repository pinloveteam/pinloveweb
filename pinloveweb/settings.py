...
MEDIA_ROOT ='http://www.pinpinlove.com/static/update'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://example.com/media/", "http://media.example.com/"
MEDIA_URL = 'http://www.pinpinlove.com/static/update/'
...
STATICFILES_DIRS = (
    ("assets", "http://www.pinpinlove.com/static"), 
    ("update", "http://www.pinpinlove.com/update"),  
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
   "http://www.pinpinlove.com/templates", 
   "http://www.pinpinlove.com/apps/user_app/templates", 
)
