...
# under the License.
from apps.third_party_login_app.setting import FaceBookAppSecret
...
class GraphAPI(object):
    ...
    def permissions(self):
        ...
        try:
            permissions = {}
            permissions_response = self.get_object('me/permissions')
    ...
    def get_friends(self):
        friends=self.get_connections("me", "friends")
        return friends['data']
...
def cookie_signature(*parts):
    ...
    """
    hash = hmac.new(FaceBookAppSecret, digestmod=hashlib.sha1)
    for part in parts:
        hash.update(part)
