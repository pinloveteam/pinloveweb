...
class user_basic_profile(models.Model):
    ...
    gender = models.CharField(verbose_name=r"性别", max_length=1, choices=GENDER_CHOICES, default=MALE,null=True) 
    
    YEAR_OF_BIRTH_CHOICES = ((-1,r'请选择'),)
    for year in range(1900,2013):  
        YEAR_OF_BIRTH_CHOICES += ((year, str(year)),)
    year_of_birth = models.SmallIntegerField(verbose_name=r"出生年份", choices=YEAR_OF_BIRTH_CHOICES, default=-1,null=True) 

    MONTH_OF_BIRTH_CHOICES = ((-1,r'请选择'),)
    for month in range(1,13):  
        MONTH_OF_BIRTH_CHOICES += ((month, str(month)),)
    month_of_birth = models.SmallIntegerField(verbose_name=r"出生月份", choices=MONTH_OF_BIRTH_CHOICES, default=-1,null=True)  
    
    DAY_OF_BIRTH_CHOICES = ((-1,r'请选择'),)
    ...
    age = models.IntegerField(verbose_name=r"年龄",max_length=11,null=True)
    #calculate  age
    def cal_age(self):
        current_year = time.strftime('%Y', time.localtime(time.time()))
        self.age = string.atoi(current_year) - self.year_of_birth
    
    SUN_SIGN_CHOOSICE=((-1,r'请选择'),(1,r'水瓶座'),(2,r'双鱼座'),(3,r'白羊座'),(4,r'金牛座'),(5,r'双子座'),(6,r'巨蟹座'),(7,r'狮子座'),(8,r'处女座'),(9,r'天秤座'),(10,r'天蝎座'),(11,r'射手座'),(12,r'摩羯座'),)
    sunSign=models.SmallIntegerField(verbose_name=r"星座",choices=SUN_SIGN_CHOOSICE,null=True,default=-1)
    #calculate  sunSign
    ...
    ZODIAC_CHOOSICE=((-1,r'请选择'),(0,r'鼠'),(1,r'牛'),(2,r'虎'),(3,r'兔'),(4,r'龙'),(5,r'蛇'),(6,r'马'),(7,r'羊'),(8,r'猴'),(9,r'鸡'),(10,r'狗'),(11,r'猪'),)
    zodiac=models.SmallIntegerField(verbose_name=r"生肖",choices=ZODIAC_CHOOSICE,null=True,default=-1)
    #calculate  zodiac
    def cal_zodiac(self):
        self.zodiac=(self.year_of_birth-1900)%12
    
    ETHNICGROUP_CHOOSICE=((-1,r'请选择'),(1,r'汉族'),(2,r'蒙古族'),(3,r'满族'),(4,r'朝鲜族'),(5,r'赫哲族'),(6,r'达斡尔族'),(7,r'鄂温克族'),(8,r'鄂伦春族'),(9,r'回族'),(10,r'东乡族'),(11,r'土族'),(12,r'撒拉族'),(13,r'保安族'),(14,r'裕固族'),(15,r'维吾尔族'),(16,r'哈萨克族'),(17,r'柯尔克孜族'),(18,r'锡伯族'),(19,r'塔吉克族'),(20,r'乌孜别克族'),(21,r'俄罗斯族'),(22,r'塔塔尔族'),(23,r'藏族'),(24,r'门巴族'),(25,r'珞巴族'),(26,r'羌族'),(27,r'彝族'),(28,r'白族'),(29,r'哈尼族'),(30,r'傣族'),(31,r'僳僳族'),(32,r'佤族'),(33,r'拉祜族'),(34,r'纳西族'),(35,r'景颇族'),(36,r'布朗族'),(37,r'阿昌族'),(38,r'普米族'),(39,r'怒族'),(40,r'德昂族'),(41,r'独龙族'),(42,r'基诺族'),(43,r'苗族'),(44,r'布依族'),(45,r'侗族'),(46,r'水族'),(47,r'仡佬族'),(48,r'壮族'),(49,r'瑶族'),(50,r'仫佬族'),(51,r'毛南族'),(52,r'京族'),(53,r'土家族'),(54,r'黎族'),(55,r'畲族'),(56,r'高山族'),)
    ethnicGroup=models.SmallIntegerField(verbose_name=r"民族",choices=ETHNICGROUP_CHOOSICE,null=True,default=-1)
    
    BLOODTYPE_CHOOSICE=(('N',r'请选择'),('A',r'A血型'),('B',r'B血型'),('AB',r'AB血型'),('O',r'O血型'),('0',r'其他血型'),)
    bloodType=models.CharField(verbose_name=r'血型',choices=BLOODTYPE_CHOOSICE,max_length=2,null=True,default='N')
    
    HEIGHT_CHOICES = ((-1,r'请选择'),)
    for height in range(130,226):  
        HEIGHT_CHOICES += ((height, str(height)),)
    height = models.IntegerField(verbose_name=r"身高（厘米）", choices=HEIGHT_CHOICES, default=-1,null=True)  # height=models.IntegerField(max_length=8) 
    ...
    WIDOWED = 'W'
    SEPARATED = 'P'
    MARITAL_STATUS_CHOICES = ( ('N', r'请选择'),(SINGLE, r'单身'), (MARRIED, r'已婚'), (DIVORCED, r'离婚'), (SEPARATED, r'分居'), (WIDOWED, r'丧偶'))
    maritalStatus = models.CharField(verbose_name=r"婚姻状态", max_length=1, choices=MARITAL_STATUS_CHOICES, default='N',null=True)  
    
    hasChild=models.NullBooleanField(verbose_name=r"是否有孩子",choices=((True,r'有'),(False,r'无')),null=True)
    ...
    master=3 #硕士
    doctor=4 # 博士 
    EDUCATION_DEGREE_CHOICES=((choice,r'请选择'),(secondary,r'中专'),(junior,r'大专'),(Bachelor,r'本科'),(master,r'硕士 '),(doctor,r'博士 '),)
    education = models.IntegerField(verbose_name=r"学位",choices=EDUCATION_DEGREE_CHOICES, default=-1,null=True) # educate = models.CharField(max_length=50)
    
    # personal web and links 
    link=models.CharField(verbose_name=r"共享链接",max_length=128,default='me',null=True)  

    
    # location
    country = models.CharField(verbose_name=r"所在国家", max_length=50,null=True)
    stateProvince = models.CharField(verbose_name=r"所在省", max_length=50,null=True) 
    
    city = models.CharField(verbose_name=r"所在城市", max_length=50,null=True) 
    streetAddress = models.CharField(verbose_name=r"街道地址", max_length=255,null=True) # address = models.CharField(max_length=255)
    
    INCOME_CHOICES = ((-1,"请选择"),(1,"5万以下"))
    for income in range(5,100,1):  
        INCOME_CHOICES += ((income, str(income)),)
    INCOME_CHOICES += ((100000, "100万以上"),)
    income = models.IntegerField(verbose_name=r"年薪（万元）", choices=INCOME_CHOICES, default=-1,null=True) # payRang=models.CharField(max_length=50)
   
    position=models.CharField(verbose_name=r'定位',max_length=10,null=True)
    
    # photo
    photo = models.ImageField(verbose_name=r"头像",upload_to='user_img',max_length=128,default='' ,null=True)
     
    language=models.CharField(verbose_name='语言能力',max_length=20,null=True)
    
    
class user_contact_link(models.Model):
    user=models.ForeignKey(User)
    
    trueName = models.CharField(verbose_name=r"真实姓名", max_length=50,null=True)
    
    # phone number 
    mobileNumber = models.CharField(verbose_name=r"手机号码", max_length=20,null=True,)
    
    IDCardNumber=models.CharField(verbose_name=r"身份证号", max_length=50,null=True)
    
    QQ=models.CharField(verbose_name=r"QQ", max_length=20,null=True)
    
    MSN=models.CharField(verbose_name=r"MSN", max_length=20,null=True)
    
    CountryHome=models.CharField(verbose_name=r"户口所在地国家", max_length=50,null=True)
    stateProvinceHome=models.CharField(verbose_name=r"户口所在地省", max_length=50,null=True)
    cityHome=models.CharField(verbose_name=r"户口所在地市", max_length=50,null=True)
...
class user_appearance(models.Model):
    user=models.ForeignKey(User)
    self_evaluation=models.FloatField(verbose_name=r"自我评价",choices=((0.0,r'请选择'),(0.35,r'普通'),(0.70,r'不错'),(1.00,r'很好')),null=True,default=0.0)
    CHOICE_WEIGHT=((-1,r'请选择'),)
    for i in range(20,300,1):
        CHOICE_WEIGHT+=((i,str(i)),)
    weight=models.SmallIntegerField(verbose_name=r"体重(kg)",choices=CHOICE_WEIGHT,null=True,default=-1)
    
    HAIR_STYLE_CHOICE=(('N',r'请选择'),('0',r'顺直长发'),('1',r'卷曲长发'),('2',r'中等长度'),('3',r'短发'),('4',r'平头'),('5',r'光头'),('6',r'其他'),)
    hairStyle=models.CharField(verbose_name=r"发型",choices=HAIR_STYLE_CHOICE,max_length=2,null=True,default='N')
    
    HAIR_COLOR_CHOICE=(('N',r'请选择'),('0',r'黑色'),('1',r'金色'),('2',r'褐色'),('3',r'栗色'),('4',r'灰色'),('5',r'红色'),('6',r'白色'),('7',r'挑染'),('8',r'光头'),('9',r'其他'),)
    hairColor=models.CharField(verbose_name=r"发型",choices=HAIR_COLOR_CHOICE,max_length=2,null=True,default='N')
    
    FACE_CHOICE=(('N',r'请选择'),('0',r'圆脸型'),('1',r'方脸型'),('2',r'长脸型'),('3',r'瓜子脸型'),('4',r'国字脸型'),('5',r'三角脸型'),('6',r'菱形脸型'),('7',r'其他'),)
    face=models.CharField(verbose_name=r"发型",choices=HAIR_STYLE_CHOICE,max_length=2,null=True,default='N')
    
    EYE_COLOR_CHOICE=(('N',r'请选择'),('0',r'黑色'),('1',r'蓝色'),('2',r'浅褐色'),('3',r'棕色'),('4',r'灰色'),('5',r'绿色'),('6',r'其它'),)
    eyeColor=models.CharField(verbose_name=r"发型",choices=HAIR_STYLE_CHOICE,max_length=2,null=True,default='N')
    
    BODY_SHAPE_CHOICE=(('N',r'请选择'),('0',r'苗条'),('1',r'匀称'),('2',r'高挑'),('3',r'丰满'),('4',r'健壮'),('5',r'魁梧'),('6',r'其他'),)
...
class user_study_work(models.Model):
    user=models.ForeignKey(User)
    # current job 
    JOB_INDUSRY_CHOICE=((-1,r'请选择'),(0,r'计算机/互联网/通信'),(1,r'公务员/事业单位'),(2,r'教师'),(3,r'医生'),(4,r'护士'),(5,r'空乘人员'),
    ...
    jOB_TITLE=((-1,r'请选择'),(0,r'普通职员'),(1,r'中层管理者'),(2,r'高层管理者'),(3,r'企业主'),)
    jobTitle = models.IntegerField(verbose_name=r"目前职位",choices=jOB_TITLE, max_length=50,null=True,default=-1) 
    
    COMPANY_TYPE_CHOICE=(('N',r'请选择'),('0',r'政府机关'),('1',r'事业单位'),('2',r'外企企业'),('3',r'上市公司'),('4',r'国有企业'),('5',r'私营企业'),('6',r'自有公司'),)
    companyType=models.CharField(verbose_name=r"公司性质", choices=COMPANY_TYPE_CHOICE,max_length=2,null=True,default='N') 
    
    WORK_STATUS_CHOICE=(('N',r'请选择'),('0',r'轻松稳定'),('1',r'朝九晚五'),('2',r'偶尔加班'),('3',r'经常加班'),('4',r'偶尔出差'),('5',r'经常出差'),('6',r'经常有应酬'),('7',r'工作时间自由'),('8',r'其他'),)
    ...
    educationSchool = models.CharField(verbose_name=r"最高学位毕业学校", max_length=100,null=True) 
...
class user_personal_habit(models.Model):
    ...
    BELIEF_CHOICE=(('N',r'请选择'),('0',r'无宗教信仰'),('1',r'佛教'),('2',r'基督教'),('3',r'犹太教'),('4',r'伊斯兰教'),('5',r'印度教'),('6',r'神道教'),('7',r'其他'),)
    belief=models.CharField(verbose_name=r"信仰",choices=BELIEF_CHOICE, max_length=2,null=True,default='N') 
   
    SMOKE_CHOICE=(('N',r'请选择'),('0',r'不吸烟'),('1',r'社交时偶尔吸'),('2',r'每周吸几次'),('3',r'每天都吸'),)
    isSmoke=models.CharField(verbose_name=r"吸烟",choices=SMOKE_CHOICE, max_length=2,null=True,default='N') 
    
    DRINK_CHOICE=(('N',r'请选择'),('0',r'不喝'),('1',r'社交时喝酒'),('2',r'有兴致时喝'),('3',r'每天都离不开酒)'),)
    isDrink=models.CharField(verbose_name=r"喝酒",choices=DRINK_CHOICE, max_length=2,null=True,default='N') 
    
    BEDDING_TIME_CHOICE=(('N',r'请选择'),('0',r'早睡早起很规律'),('1',r'经常夜猫子'),('2',r'总是早起鸟'),('3',r'偶尔懒散一下'),('4',r'总是早起鸟'),('5',r'没有规律'),)
...
class user_family_information(models.Model):
    user=models.ForeignKey(User)
    MONTHLY_EXPENSE_CHOICE=((-1,r'请选择'),(1,r'1000元以下'),)
    ...
    financialCondition=models.CharField(verbose_name=r'家庭经济条件',choices=(('N',r'请选择'),('0',r'富裕'),('1',r'小康'),('2',r'温饱'),),max_length=1,null=True,default='N')
    parentEducation=models.CharField(verbose_name=r'父母受教育水平',choices=(('N',r'请选择'),('0',r'高级知识分子'),('1',r'普通知识分子'),),max_length=1,null=True,default='N')
    
class user_family_life(models.Model):
    user=models.ForeignKey(User)
    liveWithParent=models.CharField(verbose_name=r'愿与Ta父母同住',choices=(('N',r'请选择'),('0',r'愿意'),('1',r'不愿意'),('2',r'视情况而定'),),max_length=1,null=True)
    likeChild=models.CharField(verbose_name=r'是否喜欢有孩子',choices=(('N',r'请选择'),('0',r'愿意'),('1',r'不愿意'),('2',r'视情况而定'),),max_length=1,null=True)
...
def _delete_crop_avatar_on_disk(sender, instance, *args, **kwargs):
    ...
    if path:
        try:
            ...
            pass
avatar_crop_done.connect(_delete_crop_avatar_on_disk,sender=User)