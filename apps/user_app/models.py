...
####user_basic_profile###
    ...
    BLOODTYPE_CHOOSICE=(('N',r'未填'),('A',r'A血型'),('B',r'B血型'),('AB',r'AB血型'),('O',r'O血型'),('0',r'其他血型'),)
    ...
    streetAddress = models.CharField(verbose_name=r"街道地址", max_length=255,null=True)
    ...
    avatar_name = models.CharField(verbose_name=r"头像",max_length=128,default='user_img/image.png',null=True)
    """
           1:未上传  
           2.正在审核
           3.审核通过
    """
    STATUS_CHOICES = (('1',"未上传"),('2',"正在审核"),('3',"审核通过"),)
    avatar_name_status= models.CharField(verbose_name=r"头像状态",max_length=2, choices=STATUS_CHOICES,default='1',null=True)
...
####user_appearance###
    self_evaluation=models.FloatField(verbose_name=r"自我评价",choices=((0.0,r'未填'),(0.35,r'普通'),(0.70,r'不错'),(1.00,r'很好')),null=True,default=0.0)
...
class user_contact_link(models.Model):
    ...
    IDCardChoice=models.IntegerField(verbose_name=r"护照类型",choices=ID_CARD_CHIOSE,null=True ,default=-1)
...
class School(models.Model):
    ...
    """
    type=models.CharField(verbose_name=r'大学类型',max_length=2,null=True)
