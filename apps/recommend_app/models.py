...
class WeightStar(models.Model):
    user=models.ForeignKey(User)
    height=models.IntegerField(verbose_name=u"身高权重",default=0)
    income=models.IntegerField(verbose_name=u"收入分数",default=0)
    education=models.IntegerField(verbose_name=u"学历分数",default=0)
    appearance=models.IntegerField(verbose_name=u"外貌分数",default=0)
    character=models.IntegerField(verbose_name=u"性格权重",default=0)

    class Meta:
        verbose_name = u'权重数值' 
        verbose_name_plural = u'权重数值'
