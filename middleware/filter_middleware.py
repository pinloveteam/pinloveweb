...
class AuthenticationMiddleware(object):   
    def process_request(self, request):  
        passList=['/user/reset_password/','/account/forget_password/','/account/auth/','/account/register/','/','/game/jigsaw/','/game/pintu_for_facebook/','/pay_app/icon/','/pay_app/exchange_game_count/','/game/request_life/','/game/confirm_request_life/(.+)/','/account/check_username/']
